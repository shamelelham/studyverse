...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2026 at 09:06 PM
...
--
-- Table structure for table `papers_comments`
--
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `level`, `bio`, `avatar`, `is_active`, `created_at`, `update_at`) VALUES
(1, 'Admin', 'admin@studyverse.com', 'password123', 'Admin', 'University', NULL, NULL, 1, '2026-05-05 02:51:42', '2026-05-05 02:51:42'),
(2, 'Amirahanis', 'hanis@gmail.com', 'password123', 'Student', 'Secondary School', NULL, NULL, 1, '2026-05-05 02:51:42', '2026-05-05 02:51:42');
...
--
-- Indexes for table `papers_comments`
--
ALTER TABLE `papers_comments`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `papers_comments`
--
ALTER TABLE `papers_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `papers_comments`
--
ALTER TABLE `papers_comments`
  ADD CONSTRAINT `papers_comments_ibfk_1` FOREIGN KEY (`paper_id`) REFERENCES `papers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `papers_comments_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
